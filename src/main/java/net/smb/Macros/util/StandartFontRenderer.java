...
public class StandartFontRenderer implements IResourceManagerReloadListener
{
    ...
    public StandartFontRenderer(GameSettings p_i1035_1_, ResourceLocation p_i1035_2_, TextureManager p_i1035_3_, boolean p_i1035_4_)
    {
    ...
    private void readGlyphSizes()
    {
        try
        {
            InputStream var1 = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("macroscore", "font/glyph_sizes.bin")).getInputStream();
    ...
    private ResourceLocation getUnicodePageLocation(int p_111271_1_)
    {
        ...
        {
        	if(p_111271_1_ == 0 || p_111271_1_ == 4 || p_111271_1_ == 25 || p_111271_1_ == 43) unicodePageLocations[p_111271_1_] = new ResourceLocation("macroscore", String.format("font/unicode_page_%02x.png", new Object[] {Integer.valueOf(p_111271_1_)}));
        	else unicodePageLocations[p_111271_1_] = new ResourceLocation(String.format("textures/font/unicode_page_%02x.png", new Object[] {Integer.valueOf(p_111271_1_)}));
        }
     ...
     */
    public int drawStringWithShadow(String p_78261_1_, int p_78261_2_, int p_78261_3_, Color color)
    {
        return this.drawString(p_78261_1_, p_78261_2_, p_78261_3_, color, true);
    }

    /**
     * Draws the specified string.
     */
    public int drawString(String p_78276_1_, int p_78276_2_, int p_78276_3_, Color color)
    {
        return this.drawString(p_78276_1_, p_78276_2_, p_78276_3_, color, false);
    }

    /**
     * Draws the specified string. Args: string, x, y, color, dropShadow
     */
    public int drawString(String p_85187_1_, int p_85187_2_, int p_85187_3_, Color color, boolean p_85187_5_)
    {
        ...
        if (p_85187_5_)
        {
            var6 = this.renderString(p_85187_1_, p_85187_2_ + 1, p_85187_3_ + 1, color, true);
            var6 = Math.max(var6, this.renderString(p_85187_1_, p_85187_2_, p_85187_3_, color, false));
        }
        else
        {
            var6 = this.renderString(p_85187_1_, p_85187_2_, p_85187_3_, color, false);
        }
     ...
     */
    private int renderStringAligned(String p_78274_1_, int p_78274_2_, int p_78274_3_, int p_78274_4_, Color color, boolean p_78274_6_)
    {
        if (this.bidiFlag)
        {
        ...
        return this.renderString(p_78274_1_, p_78274_2_, p_78274_3_, color, p_78274_6_);
    }

    /**
     * Render single line string by setting GL color, current (posX,posY), and calling renderStringAtPos()
     */
    private int renderString(String p_78258_1_, int p_78258_2_, int p_78258_3_, Color color, boolean p_78258_5_)
    {
        if (p_78258_1_ == null)
        {
            return 0;
        ...
        else
        {
            ...
            if (p_78258_5_)
            {
                RenderUtil.setColor(Color.color_3);
            }
            else RenderUtil.setColor(color);
            
            this.red = color.colorR;
            this.blue = color.colorB;
            this.green = color.colorG;
            this.alpha = color.colorA;
    ...
    {
        return this.trimStringToWidth(p_78269_1_, p_78269_2_, false, 1.0F);
    }

    /**
     * Trims a string to a specified width, and will reverse it if par3 is set.
     */
    public String trimStringToWidth(String p_78262_1_, int p_78262_2_, boolean p_78262_3_, float scale)
    {
        ...
        for (int var10 = var6; var10 >= 0 && var10 < p_78262_1_.length() && var5 < p_78262_2_; var10 += var7)
        {
            ...
            float var12 = this.getCharWidth(var11)*scale;
    ...
    private void renderSplitString(String p_78268_1_, int p_78268_2_, int p_78268_3_, int p_78268_4_, boolean p_78268_5_)
    {
        ...
        for (Iterator var7 = var6.iterator(); var7.hasNext(); p_78268_3_ += this.FONT_HEIGHT)
        {
            ...
            this.renderStringAligned(var8, p_78268_2_, p_78268_3_, p_78268_4_, Color.color_4, p_78268_5_);
        }
    }
